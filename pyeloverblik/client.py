...
class EloverblikApiClient:
    ...
    @staticmethod
    def format_metering_point_label(metering_point: dict[str, Any]) -> str:
    ...
    _format_metering_point_label = format_metering_point_label
    ...
    _invalidate_access_token = invalidate_access_token
            ...
            metering_points.append(
                {
                    ...
                    "label": self.format_metering_point_label(metering_point),
                }
            )
    ...
    async def async_get_latest_consumption(
        ...
        return self.parse_time_series(data, local_time_zone=self._local_time_zone)
    ...
    _parse_time_series = parse_time_series
